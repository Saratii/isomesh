...
impl SMat3 {
    pub(crate) const ZERO: Self = Self::new();
    ...
    #[inline]
    pub(crate) fn set_symmetric_from(&mut self, rhs: &SMat3) {
        *self = *rhs;
    }
    ...
    #[inline]
    #[must_use]
    pub(crate) fn off(&self) -> f32 {
        (self.m01 * self.m01 + self.m02 * self.m02 + self.m12 * self.m12).sqrt() * SQRT_2
    }
    ...
    #[inline]
    pub(crate) fn rot01(&mut self, c: &mut f32, s: &mut f32) {
    ...
    #[inline]
    pub(crate) fn rot02(&mut self, c: &mut f32, s: &mut f32) {
    ...
    #[inline]
    pub(crate) fn rot12(&mut self, c: &mut f32, s: &mut f32) {
